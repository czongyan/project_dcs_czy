...
! function (t, n) {
	...
	function p(t, n, e) {
		var r = Math.abs(n - t) / Math.max(0, e)
			...
			, o = r / i;
		return o >= Pd ? i *= 10 : o >= qd ? i *= 5 : o >= Ld && (i *= 2), n < t ? -i : i
	}
	...
	function v() {
		function t(t) {
			...
			for (i = 0; i < u; ++i) o = a[i], s <= o && o <= f && v[Sd(l, o, 0, p)].push(t[i]);
			return v
		}
		var n = f
			, e = c
		...
		return t.value = function (e) {
			...
			return arguments.length ? (r = "function" == typeof n ? n : s(Array.isArray(n) ? Cd.call(n) : n), t) : r
		}, t
	}
	...
	function y(t, e, r) {
		return t = zd.call(t, o).sort(n), Math.ceil((r - e) / (2 * (_(t, .75) - _(t, .25)) * Math.pow(t.length, -1 / 3)))
	}
	...
	function rt(t) {
		return 1 - Math.cos(t * Bd)
	}

	function it(t) {
		return Math.sin(t * Bd)
	}

	function ot(t) {
		return (1 - Math.cos(Yd * t)) / 2
	}
	...
	function pt(t) {
		return (t = +t) < jd ? Qd * t * t : t < Xd ? Qd * (t -= Hd) * t + Vd : t < $d ? Qd * (t -= Wd) * t + Zd : Qd * (t -= Gd) * t + Jd
	}
	...
	function St(t) {
		...
		for (f < c && (c = this._x0, f = this._x1), l < s && (s = this._y0, l = this._y1), this.cover(c, s).cover(f, l), e = 0; e < o; ++e) Nt(this, u[e], a[e], t[e]);
		return this
	}
	...
	function $t(t) {
		for (; t._start = t._waiting && t._active < t._size;) {
			var n = t._ended + t._active
				...
				, r = e.length - 1
				, i = e[r];
			e[r] = Zt(t, n), --t._waiting, ++t._active, e = i.apply(null, e), t._tasks[n] && (t._tasks[n] = e || vv)
		}
	}
	...
	function un(t) {
		return t >= 1 ? gv : t <= -1 ? -gv : Math.asin(t)
	}
	...
	function sn() {
		function t() {
			var t, s, f = +n.apply(this, arguments)
				...
				, h = o.apply(this, arguments) - gv
				, p = u.apply(this, arguments) - gv
				, d = Math.abs(p - h)
				, v = p > h;
			if (c || (c = t = Tt()), l < f && (s = l, l = f, f = s), l > _v)
				if (d > mv - _v) c.moveTo(l * Math.cos(h), l * Math.sin(h)), c.arc(0, 0, l, h, p, !v), f > _v && (c.moveTo(f * Math.cos(p), f * Math.sin(p)), c.arc(0, 0, f, p, h, v));
				else {
					var _, y, g = h
						, m = p
						, x = h
						...
						, k = T > _v && (i ? +i.apply(this, arguments) : Math.sqrt(f * f + l * l))
					...
					if (k > _v) {
						var E = un(k / f * Math.sin(T))
							, C = un(k / l * Math.sin(T));
						(w -= 2 * E) > _v ? (E *= v ? 1 : -1, x += E, b -= E) : (w = 0, x = b = (h + p) / 2), (M -= 2 * C) > _v ? (C *= v ? 1 : -1, g += C, m -= C) : (M = 0, g = m = (h + p) / 2)
					}
					var z = l * Math.cos(g)
						, P = l * Math.sin(g)
						, q = f * Math.cos(b)
					...
					if (N > _v) {
						var R = l * Math.cos(m)
							...
							, O = f * Math.sin(x);
						if (d < yv) {
							var F = w > _v ? an(z, P, D, O, R, U, q, L) : [q, L]
								, I = z - F[0]
								, Y = P - F[1]
								, B = R - F[0]
								, j = U - F[1]
					...
					M > _v ? A > _v ? (_ = cn(D, O, z, P, l, A, v), y = cn(R, U, q, L, l, A, v), c.moveTo(_.cx + _.x01, _.cy + _.y01), A < N ? c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, A, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v), c.arc(0, 0, l, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), !v), c.arc(y.cx, y.cy, A, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v))) : (c.moveTo(z, P), c.arc(0, 0, l, g, m, !v)) : c.moveTo(z, P), f > _v && w > _v ? S > _v ? (_ = cn(q, L, R, U, f, -S, v), y = cn(z, P, D, O, f, -S, v), c.lineTo(_.cx + _.x01, _.cy + _.y01), S < N ? c.arc(_.cx, _.cy, S, Math.atan2(_.y01, _.x01), Math.atan2(y.y01, y.x01), !v) : (c.arc(_.cx, _.cy, S, Math.atan2(_.y01, _.x01), Math.atan2(_.y11, _.x11), !v), c.arc(0, 0, f, Math.atan2(_.cy + _.y11, _.cx + _.x11), Math.atan2(y.cy + y.y11, y.cx + y.x11), v), c.arc(y.cx, y.cy, S, Math.atan2(y.y11, y.x11), Math.atan2(y.y01, y.x01), !v))) : c.arc(0, 0, f, b, x, v) : c.lineTo(q, L)
				}
			else c.moveTo(0, 0);
		...
		return t.centroid = function () {
			var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2
				, r = (+o.apply(this, arguments) + +u.apply(this, arguments)) / 2 - yv / 2;
	...
	function gn() {
		function t(t) {
			var a, c, s, f, l, h = t.length
				...
				, y = Math.min(mv, Math.max(-mv, o.apply(this, arguments) - _))
	...
	function se() {
		...
		return t.keys = function (e) {
			return arguments.length ? (n = "function" == typeof e ? e : Kt(Wv.call(e)), t) : n
		}, t.value = function (n) {
			return arguments.length ? (i = "function" == typeof n ? n : Kt(+n), t) : i
		}, t.order = function (n) {
			return arguments.length ? (e = null == n ? ae : "function" == typeof n ? n : Kt(Wv.call(n)), t) : e
		}, t.offset = function (n) {
	...
	function Pe(t) {
		...
		var e = Oe(t.r)
			, r = Oe(t.g)
			, i = Oe(t.b)
			, o = Re((.4124564 * e + .3575761 * r + .1804375 * i) / c_)
			, u = Re((.2126729 * e + .7151522 * r + .072175 * i) / s_)
			, a = Re((.0193339 * e + .119192 * r + .9503041 * i) / f_);
	...
	function Re(t) {
		return t > d_ ? Math.pow(t, 1 / 3) : t / p_ + l_
	}

	function Ue(t) {
		return t > h_ ? t * t * t : p_ * (t - l_)
	}
	...
	function Be(t) {
		...
		var n = t.r / 255
			, e = t.g / 255
			, r = t.b / 255
			, i = (w_ * r + x_ * n - b_ * e) / (w_ + x_ - b_)
			, o = r - i
			, u = (m_ * (e - i) - y_ * o) / g_
			, a = Math.sqrt(u * u + o * o) / (m_ * i * (1 - i))
			, c = a ? Math.atan2(u, o) * u_ - 120 : NaN;
	...
	function ar(t, n) {
		var e, r, i, o = C_.lastIndex = z_.lastIndex = 0
			, u = -1
			, a = []
			, c = [];
		for (t += "", n += "";
			(e = C_.exec(t)) && (r = z_.exec(n));)(i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i), (e = e[0]) === (r = r[0]) ? a[u] ? a[u] += r : a[++u] = r : (a[++u] = null, c.push({
			i: u
			, x: rr(e, r)
		})), o = z_.lastIndex;
	...
	function cr(t, n) {
		var e, r = typeof n;
		return null == n || "boolean" === r ? $e(n) : ("number" === r ? rr : "string" === r ? (e = be(n)) ? (n = e, S_) : ar : n instanceof be ? S_ : n instanceof Date ? er : Array.isArray(n) ? nr : isNaN(n) ? ir : rr)(t, n)
	}
	...
	function fr(t, n, e, r, i, o) {
		...
		return (u = Math.sqrt(t * t + n * n)) && (t /= u, n /= u), (c = t * e + n * r) && (e -= t * c, r -= n * c), (a = Math.sqrt(e * e + r * r)) && (e /= a, r /= a, c /= a), t * r < n * e && (t = -t, n = -n, c = -c, u = -u), {
			translateX: i
			, translateY: o
			, rotate: Math.atan2(n, t) * P_
			, skewX: Math.atan(c) * P_
			, scaleX: u
			, scaleY: a
		}
	}
	...
	function lr(t) {
		return "none" === t ? q_ : (M_ || (M_ = document.createElement("DIV"), T_ = document.documentElement, k_ = document.defaultView), M_.style.transform = t, t = k_.getComputedStyle(T_.appendChild(M_), null).getPropertyValue("transform"), T_.removeChild(M_), t = t.slice(7, -1).split(","), fr(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]))
	}

	function hr(t) {
		return null == t ? q_ : (N_ || (N_ = document.createElementNS("http://www.w3.org/2000/svg", "g")), N_.setAttribute("transform", t), (t = N_.transform.baseVal.consolidate()) ? (t = t.matrix, fr(t.a, t.b, t.c, t.d, t.e, t.f)) : q_)
	}
	...
	function yr(t, n) {
		var e, r, i = t[0]
			...
			, l = c - o
			, h = f * f + l * l;
		if (h < F_) r = Math.log(s / u) / U_, e = function (t) {
			return [i + t * f, o + t * l, u * Math.exp(U_ * t * r)]
		};
		else {
			var p = Math.sqrt(h)
				, d = (s * s - u * u + O_ * h) / (2 * u * D_ * p)
				, v = (s * s - u * u - O_ * h) / (2 * s * D_ * p)
				, _ = Math.log(Math.sqrt(d * d + 1) - d)
				, y = Math.log(Math.sqrt(v * v + 1) - v);
			r = (y - _) / U_, e = function (t) {
				var n = t * r
					, e = dr(_)
					, a = u / (D_ * p) * (e * _r(U_ * n + _) - vr(_));
				return [i + a * f, o + a * l, u * e / dr(U_ * n + _)]
			}
		}
	...
	function Sr(t, n, e) {
		for (var r = 0, i = t.length; r < i; ++r)
			if (t[r].name === n) {
				t[r] = V_, t = t.slice(0, r).concat(t.slice(r + 1));
				break
			}
	...
	function Br() {
		Or(), ++ly;
		for (var t, n = W_; n;)(t = _y - n._time) >= 0 && n._call.call(null, t), n = n._next;
		--ly
	}

	function jr(t) {
		_y = (vy = t || gy.now()) + yy, ly = hy = 0;
		try {
			Br()
		}
		finally {
	...
	function Xr() {
		for (var t, n, e = W_, r = 1 / 0; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : W_ = n);
		$_ = t, Vr(r)
	}

	function Vr(t) {
		if (!ly) {
			hy && (hy = clearTimeout(hy));
			var n = t - _y;
			n > 24 ? (t < 1 / 0 && (hy = setTimeout(jr, n)), py && (py = clearInterval(py))) : (py || (py = setInterval(Hr, dy)), ly = 1, my(jr))
		}
	}
	...
	function Zr(t, n, e, r) {
		...
		return i.floor = i, i.ceil = function (e) {
			...
			return xy.setTime(+n), by.setTime(+r), t(xy), t(by), Math.floor(e(xy, by))
		}, i.every = function (t) {
	...
	function Gr(t) {
		return Zr(function (n) {
			...
			return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * ky) / Ay
		})
	}
	...
	function ei(t, n) {
		...
		var r = e[0]
			, i = e[1]
			, o = i - (Tg = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1
			, u = r.length;
	...
	function oi(t) {
		if (!(n = Sg.exec(t))) throw new Error("invalid format: " + t);
		var n, e = n[1] || " "
			, r = n[2] || ">"
			, i = n[3] || "-"
			, o = n[4] || ""
			...
			, s = n[8] && +n[8].slice(1)
			, f = n[9] || "";
		"n" === f ? (c = !0, f = "g") : Ng[f] || (f = ""), (u || "0" === e && "=" === r) && (u = !0, e = "0", r = "="), this.fill = e, this.align = r, this.sign = i, this.symbol = o, this.zero = u, this.width = a, this.comma = c, this.precision = s, this.type = f
	}
		...
		function n(t) {
			function n(t) {
				...
				if ("c" === p) m = _(t) + m, t = "";
					...
					if (g = (x ? "(" === a ? a : "-" : "-" === a || "(" === a ? "" : a) + g, m = m + ("s" === p ? Eg[8 + Tg / 3] : "") + (x && "(" === a ? ")" : ""), y)
	...
	function ci(n) {
		return Ag = ai(n), t.format = Ag.format, t.formatPrefix = Ag.formatPrefix, Ag
	}
		...
		function n(t, n) {
			return function (e) {
				var r, i, o, u = []
					...
					, c = 0
					, s = t.length;
				for (e instanceof Date || (e = new Date((+e))); ++a < s;) 37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = zg[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
		...
		function r(t, n, e, r) {
			for (var i, o, u = 0, a = n.length, c = e.length; u < a;) {
				...
				if (i = n.charCodeAt(u++), 37 === i) {
					if (i = n.charAt(u++), o = B[i in zg ? n.charAt(u++) : i], !o || (r = o(t, e, r)) < 0) return -1
				}
	...
	function Mi(t, n, e) {
		var r = Pg.exec(n.slice(e, e + 4));
		return r ? (t.y = +r[0], e + r[0].length) : -1
	}

	function Ti(t, n, e) {
		var r = Pg.exec(n.slice(e, e + 2));
	...
	function Di(t, n) {
		return _i(1 + Ry.count(Ky(t), t), n, 3)
	}
	...
	function Ji(t, n) {
		return _i(1 + og.count(Mg(t), t), n, 3)
	}
	...
	function so(n) {
		return Cg = vi(n), t.timeFormat = Cg.format, t.timeParse = Cg.parse, t.utcFormat = Cg.utcFormat, t.utcParse = Cg.utcParse, Cg
	}
	...
	function ho(t) {
		...
		var e = q()
			, r = []
			, i = Yg;
		return t = null == t ? [] : Ig.call(t), n.domain = function (t) {
			if (!arguments.length) return r.slice();
			r = [], e = q();
			for (var i, o, u = -1, a = t.length; ++u < a;) e.has(o = (i = t[u]) + "") || e.set(o, r.push(i));
			return n
		}, n.range = function (e) {
			return arguments.length ? (t = Ig.call(e), n) : t.slice()
	...
	function ko(t, n) {
		...
		return r.invert = function (t) {
			...
			return arguments.length ? (a = Fg.call(t, go), e()) : a.slice()
		}, r.range = function (t) {
			return arguments.length ? (c = Ig.call(t), e()) : c.slice()
		}, r.rangeRound = function (t) {
			return c = Ig.call(t), s = sr, e()
		}, r.clamp = function (t) {
	...
	function Eo() {
		...
		return t.invert = t, t.domain = t.range = function (e) {
			return arguments.length ? (n = Fg.call(e, go), t) : n.slice()
		}, t.copy = function () {
			return Eo().domain(n)
		}, So(t)
	}
	...
	function Yo() {
		...
		return e.invertExtent = function (t) {
			...
			return arguments.length ? (i = Ig.call(n), t()) : i.slice()
	...
	function Bo() {
		...
		return t.domain = function (t) {
			...
			return arguments.length ? (i = (u = Ig.call(t)).length - 1, n()) : u.slice()
	...
	function jo() {
		function t(t) {
			if (t <= t) return e[Sd(n, t, 0, r)]
		}
		var n = [.5]
			, e = [0, 1]
			, r = 1;
		return t.domain = function (i) {
			return arguments.length ? (n = Ig.call(i), r = Math.min(n.length, e.length - 1), t) : n.slice()
		}, t.range = function (i) {
			return arguments.length ? (e = Ig.call(i), r = Math.min(n.length, e.length - 1), t) : e.slice()
		}, t.invertExtent = function (t) {
			var r = e.indexOf(t);
			return [n[r - 1], n[r]]
		}, t.copy = function () {
	...
	function Vo(t, n, r, i, o, u, a, c, s) {
		...
		function l(n, r, i, o) {
			if (null == n && (n = 10), "number" == typeof n) {
				...
				a === T.length ? (o = p(r / Zg, i / Zg, n), n = t) : a ? (a = T[u / T[a - 1][2] < T[a][2] / u ? a - 1 : a], o = a[1], n = a[0]) : (o = p(r, i, n), n = c)
			}
		...
		var h = ko(mo, rr)
			...
			, w = s("%B")
			, M = s("%Y")
			, T = [[a, 1, jg], [a, 5, 5 * jg], [a, 15, 15 * jg], [a, 30, 30 * jg], [u, 1, Hg], [u, 5, 5 * Hg], [u, 15, 15 * Hg], [u, 30, 30 * Hg], [o, 1, Xg], [o, 3, 3 * Xg], [o, 6, 6 * Xg], [o, 12, 12 * Xg], [i, 1, Vg], [i, 2, 2 * Vg], [r, 1, Wg], [n, 1, $g], [n, 3, 3 * $g], [t, 1, Zg]];
		return h.invert = function (t) {
			return new Date(d(t))
		}, h.domain = function (t) {
			return arguments.length ? v(Fg.call(t, Xo)) : v().map(Ho)
	...
	function Wo() {
		return Vo(Ky, Jy, Dy, Ry, qy, zy, Ey, wy, t.timeFormat).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)])
	}

	function $o() {
		return Vo(Mg, bg, ag, og, rg, ng, Ey, wy, t.utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)])
	}
	...
	function Go(t) {
		...
		var n = Math.abs(t - .5);
		return rm.h = 360 * t - 100, rm.s = 1.5 - 1.5 * n, rm.l = .8 - .9 * n, rm + ""
	}
	...
	function Ko(t) {
		var n = t += ""
			, e = n.indexOf(":");
		return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), sm.hasOwnProperty(n) ? {
			space: sm[n]
			, local: t
		} : t
	}
	...
	function tu(t) {
		return function () {
			var n = this.ownerDocument
				, e = this.namespaceURI;
			return e === cm && n.documentElement.namespaceURI === cm ? n.createElement(t) : n.createElementNS(e, t)
		}
	}
	...
	function su(t, n, e) {
		var r = vm.hasOwnProperty(t.type) ? ou : uu;
	...
	function Su(t, n, e, r, i, o, u) {
		var a, c, s, f = {}
			...
			, h = o.length
			, p = new Array(l);
		for (a = 0; a < l; ++a)(c = n[a]) && (p[a] = s = ym + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
		for (a = 0; a < h; ++a) s = ym + u.call(t, o[a], a, o), (c = f[s]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new Tu(t, o[a]);
	...
	function La() {
		return new qa([[document.documentElement]], gm)
	}

	function Ra(t) {
		return "string" == typeof t ? new qa([[document.querySelector(t)]], [document.documentElement]) : new qa([[t]], gm)
	}

	function Ua(t) {
		return "string" == typeof t ? new qa([document.querySelectorAll(t)], [document.documentElement]) : new qa([null == t ? [] : t], gm)
	}
	...
	function Ia(t, n) {
		...
		if (!e || !(e = e[n]) || e.state > bm) throw new Error("too late");
		return e
	}

	function Ya(t, n) {
		var e = t.__transition;
		if (!e || !(e = e[n]) || e.state > Mm) throw new Error("too late");
		return e
	}
	...
	function ja(t, n, e) {
		function r(t) {
			e.state = wm, e.delay <= t ? i(t - e.delay) : e.timer.restart(i, e.delay, e.time)
		}

		function i(r) {
			var i, c, s, f;
			for (i in a) f = a[i], f.name === e.name && (f.state === Tm ? (f.state = Nm, f.timer.stop(), f.on.call("interrupt", t, t.__data__, f.index, f.group), delete a[i]) : +i < n && (f.state = Nm, f.timer.stop(), delete a[i]));
			if (Wr(function () {
					e.state === Tm && (e.timer.restart(o, e.delay, e.time), o(r))
				}), e.state = Mm, e.on.call("start", t, t.__data__, e.index, e.group), e.state === Mm) {
				for (e.state = Tm, u = new Array(s = e.tween.length), i = 0, c = -1; i < s; ++i)(f = e.tween[i].value.call(t, t.__data__, e.index, e.group)) && (u[++c] = f);
				u.length = c + 1
			}
		}

		function o(r) {
			for (var i = r < e.duration ? e.ease.call(null, r / e.duration) : (e.state = km, 1), o = -1, c = u.length; ++o < c;) u[o].call(null, i);
			if (e.state === km) {
				e.state = Nm, e.timer.stop(), e.on.call("end", t, t.__data__, e.index, e.group);
				for (o in a)
	...
	function Ha(t, n) {
		...
		if (o) {
			n = null == n ? null : n + "";
			for (i in o)(e = o[i]).name === n ? (r = e.state === Tm, e.state = Nm, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
	...
	function Ga(t, n) {
		var e;
		return ("number" == typeof n ? rr : n instanceof be ? S_ : (e = be(n)) ? (n = e, S_) : ar)(t, n)
	}
	...
	function Ec(t, n, e) {
		var r = "transform" == (t += "") ? L_ : Ga;
		return null == n ? this.styleTween(t, kc(t, r)).on("end.style." + t, Nc(t)) : this.styleTween(t, "function" == typeof n ? Ac(t, r, Za(this, "style." + t, n)) : Sc(t, r, n), e)
	}
	...
	function Fc(t, n) {
		for (var e; !(e = t.__transition) || !(e = e[n]);)
			if (!(t = t.parentNode)) return Cm.time = Or(), Cm;
		return e
	}

	function Ic(t) {
		var n, e;
		t instanceof Uc ? (n = t._id, t = t._name) : (n = Oc(), (e = Cm).time = Or(), t = null == t ? null : t + "");
	...
	function Yc(t, n) {
		...
		if (i) {
			n = null == n ? null : n + "";
			for (r in i)
				if ((e = i[r]).state > wm && e.name === n) return new Uc([[t]], zm, n, (+r))
		}
		return null
	}
	...
	function Wc(t, n) {
		function e(e) {
			var s, f = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i
				...
				, T = x.select("text")
				, k = t === qm || t === Um ? -1 : 1
				, N = t === Um || t === Lm ? (s = "x", "y") : (s = "y", "x");
			m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "#000")), x = x.merge(w), M = M.merge(w.append("line").attr("stroke", "#000").attr(s + "2", k * u).attr(N + "1", .5).attr(N + "2", .5)), T = T.merge(w.append("text").attr("fill", "#000").attr(s, k * h).attr(N, .5).attr("dy", t === qm ? "0em" : t === Rm ? ".71em" : ".32em")), e !== g && (m = m.transition(e), x = x.transition(e), M = M.transition(e), T = T.transition(e), b = b.transition(e).attr("opacity", Dm).attr("transform", function (t) {
				return p(y, this.parentNode.__axis || y, t)
			}), w.attr("opacity", Dm).attr("transform", function (t) {
				return p(this.parentNode.__axis || y, y, t)
			})), b.remove(), m.attr("d", t === Um || t == Lm ? "M" + k * a + "," + v + "H0.5V" + _ + "H" + k * a : "M" + v + "," + k * a + "V0.5H" + _ + "V" + k * a), x.attr("opacity", 1).attr("transform", function (t) {
				return p(y, y, t)
			}), M.attr(s + "2", k * u), T.attr(s, k * h).text(l), g.filter(Vc).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === Lm ? "start" : t === Um ? "end" : "middle"), g.each(function () {
				this.__axis = y
			})
		}
		var r = []
		...
		return e.scale = function (t) {
			...
			return r = Pm.call(arguments), e
		}, e.tickArguments = function (t) {
			return arguments.length ? (r = null == t ? [] : Pm.call(t), e) : r.slice()
		}, e.tickValues = function (t) {
			return arguments.length ? (i = null == t ? null : Pm.call(t), e) : i && i.slice()
	...
	function Ss(t, n) {
		...
		for (; u;) i = u._, r = u.next, e && Ns(e, i) ? o = u : (o ? (t.tail = o, o.next = null) : t.head = t.tail = null, n.push(i), e = Ss(t, n), n.pop(), t.head ? (u.next = t.head, t.head = u) : (u.next = null, t.head = t.tail = u), o = t.tail, o.next = r), u = r;
		return t.tail = o, e
	}
	...
	function Js() {
		function t(t) {
			var r, i, o, u, a, c, s, f = t.length
				, l = new Array(f)
				, h = {};
			for (i = 0; i < f; ++i) r = t[i], a = l[i] = new ws(r), null != (c = n(r, i, t)) && (c += "") && (s = Om + (a.id = c), h[s] = s in h ? Im : a);
			for (i = 0; i < f; ++i)
				if (a = l[i], c = e(t[i], i, t), null != c && (c += "")) {
					if (u = h[Om + c], !u) throw new Error("missing: " + c);
					if (u === Im) throw new Error("ambiguous: " + c);
			...
			if (o.parent = Fm, o.eachBefore(function (t) {
	...
	function Uf() {
		...
		function e() {
			if (!f && l.apply(this, arguments)) {
				...
				n && (Ra(t.event.view).on("mousemove.drag", r, !0).on("mouseup.drag", i, !0), Ef(t.event.view), Sf(), s = !1, n("start"))
			}
		}
		...
		function o() {
			if (l.apply(this, arguments)) {
				var n, e, r = t.event.changedTouches
					...
					, o = r.length;
				for (n = 0; n < o; ++n)(e = c(r[n].identifier, i, Da, this, arguments)) && (Sf(), e("start"))
			}
		}
		...
		function a() {
			...
			for (f && clearTimeout(f), f = setTimeout(function () {
					f = null
				}, 500), n = 0; n < i; ++n)(e = d[r[n].identifier]) && (Sf(), e("end"))
		}
	...
	function Xf(t, n, e, r) {
		var i = [null, null]
			, o = Gm.push(i) - 1;
		return i.left = t, i.right = n, e && Wf(i, t, n, e), r && Wf(i, n, t, r), $m[t.index].halfedges.push(o), $m[n.index].halfedges.push(o), i
	}
	...
	function Gf(t, n, e, r) {
		for (var i, o = Gm.length; o--;) Zf(i = Gm[o], t, n, e, r) && $f(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > Km || Math.abs(i[0][1] - i[1][1]) > Km) || delete Gm[o]
	}
	...
	function nl() {
		for (var t, n, e, r, i = 0, o = $m.length; i < o; ++i)
			if ((t = $m[i]) && (r = (n = t.halfedges).length)) {
				var u = new Array(r)
					, a = new Array(r);
				for (e = 0; e < r; ++e) u[e] = e, a[e] = Qf(t, Gm[n[e]]);
	...
	function el(t, n, e, r) {
		var i, o, u, a, c, s, f, l, h, p, d, v, _ = $m.length
			, y = !0;
		for (i = 0; i < _; ++i)
			if (o = $m[i]) {
				for (u = o.site, c = o.halfedges, a = c.length; a--;) Gm[c[a]] || c.splice(a, 1);
				for (a = 0, s = c.length; a < s;) p = tl(o, Gm[c[a]]), d = p[0], v = p[1], f = Kf(o, Gm[c[++a % s]]), l = f[0], h = f[1], (Math.abs(d - l) > Km || Math.abs(v - h) > Km) && (c.splice(a, 0, Gm.push(Vf(u, p, Math.abs(d - t) < Km && r - v > Km ? [t, Math.abs(l - t) < Km ? h : r] : Math.abs(v - r) < Km && e - d > Km ? [Math.abs(h - r) < Km ? l : e, r] : Math.abs(d - e) < Km && v - n > Km ? [e, Math.abs(l - e) < Km ? h : n] : Math.abs(v - n) < Km && d - t > Km ? [Math.abs(h - n) < Km ? l : t, n] : null)) - 1), ++s);
				s && (y = !1)
			}
		if (y) {
			var g, m, x, b = 1 / 0;
			for (i = 0, y = null; i < _; ++i)(o = $m[i]) && (u = o.site, g = u[0] - t, m = u[1] - n, x = g * g + m * m, x < b && (b = x, y = o));
			if (y) {
				var w = [t, n]
					, M = [t, r]
					, T = [e, r]
					, k = [e, n];
				y.halfedges.push(Gm.push(Vf(u = y.site, w, M)) - 1, Gm.push(Vf(u, M, T)) - 1, Gm.push(Vf(u, T, k)) - 1, Gm.push(Vf(u, k, w)) - 1)
			}
		}
		for (i = 0; i < _; ++i)(o = $m[i]) && (o.halfedges.length || delete $m[i])
	}
	...
	function ol(t) {
		var n = t.circle;
		n && (n.P || (Vm = n.N), Zm.remove(n), Jm.push(n), Yf(n), t.circle = null)
	}
	...
	function cl(t) {
		ol(t), Wm.remove(t), Qm.push(t), Yf(t)
	}
	...
	function sl(t) {
		var n = t.circle
			...
			, a = [t];
		cl(t);
		for (var c = o; c.circle && Math.abs(e - c.circle.x) < Km && Math.abs(r - c.circle.cy) < Km;) o = c.P, a.unshift(c), cl(c), c = o;
		a.unshift(c), ol(c);
		for (var s = u; s.circle && Math.abs(e - s.circle.x) < Km && Math.abs(r - s.circle.cy) < Km;) u = s.N, a.push(s), cl(s), s = u;
		a.push(s), ol(s);
		var f, l = a.length;
	...
	function fl(t) {
		for (var n, e, r, i, o = t[0], u = t[1], a = Wm._; a;)
			if (r = ll(a, u) - o, r > Km) a = a.L;
			else {
				if (i = o - hl(a, u), !(i > Km)) {
					r > -Km ? (n = a.P, e = a) : i > -Km ? (n = a, e = a.N) : n = e = a;
					break
				}
				if (!a.R) {
					n = a;
		...
		Jf(t);
		var c = al(t);
		if (Wm.insert(n, c), n || e) {
			if (n === e) return ol(n), e = al(n.site), Wm.insert(c, e), c.edge = e.edge = Xf(n.site, c.site), il(n), void il(e);
	...
	function vl(t, n) {
		...
		for (Gm = [], $m = new Array(t.length), Wm = new If, Zm = new If;;)
			if (i = Vm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (fl(o), e = o[0], r = o[1]), o = t.pop();
			else {
				if (!i) break;
				sl(i.arc)
			}
		...
		this.edges = Gm, this.cells = $m, Wm = Zm = Gm = $m = null
	}

	function _l() {
		function t(t) {
			return new vl(t.map(function (r, i) {
				var o = [Math.round(n(r, i, t) / Km) * Km, Math.round(e(r, i, t) / Km) * Km];
	...
	function Nl() {
		...
		return n.transform = function (t, n) {
			...
			start: function () {
				return 1 === ++this.active && (this.index = N.push(this) - 1, this.emit("start")), this
			}
			, zoom: function (t, n) {
				return this.mouse && "mouse" !== t && (this.mouse[1] = n.invert(this.mouse[0])), this.touch0 && "touch" !== t && (this.touch0[1] = n.invert(this.touch0[0])), this.touch1 && "touch" !== t && (this.touch1[1] = n.invert(this.touch1[0])), this.that.__zoom = n, this.emit("zoom"), this
			}
			, end: function () {
				return 0 === --this.active && (N.splice(this.index, 1), this.index = -1, this.emit("end")), this
			}
			, emit: function (t) {
				lu(new gl(n, t, this.that.__zoom), S.apply, S, [t, this.that, this.args])
			}
		}, n.filter = function (t) {
			return arguments.length ? (y = "function" == typeof t ? t : yl(!!t), n) : y
		}, n.extent = function (t) {
			return arguments.length ? (g = "function" == typeof t ? t : yl([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), n) : g
	...
	function Il(n) {
		function e(t) {
			...
			e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", sx.overlay).merge(e).each(function () {
				var t = Ll(this).extent;
				Ra(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1])
			}), t.selectAll(".selection").data([zl("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", sx.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");
		...
		function u() {
			...
			function o() {
				...
				_ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, k in fx && Y.attr("cursor", sx[k = fx[k]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, k in lx && Y.attr("cursor", sx[k = lx[k]])), z = E.selection, w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [[h, d], [_, g]], r.call(T), F.brush())
			}
			...
			function u() {
				...
				I.attr("pointer-events", "all"), Y.attr("cursor", sx.overlay), Rl(z) && (E.selection = null, r.call(T)), F.end()
			}
			...
			function a() {
				...
				case 16:
					...
					break;
				case 18:
					N === ix && (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), N = ox, o());
					break;
				case 32:
					N !== ix && N !== ox || (S < 0 ? v = _ - m : S > 0 && (l = h - m), A < 0 ? y = g - x : A > 0 && (p = d - x), N = rx, Y.attr("cursor", sx.selection), o());
					break;
				default:
					return
				}
			...
			function s() {
				...
				case 16:
					...
					break;
				case 18:
					N === ox && (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), N = ix, o());
					break;
				case 32:
					N === rx && (t.event.altKey ? (S && (v = _ - m * S, l = h + m * S), A && (y = g - x * A, p = d + x * A), N = ox) : (S < 0 ? v = _ : S > 0 && (l = h), A < 0 ? y = g : A > 0 && (p = d), N = ix), Y.attr("cursor", sx[k]), o());
					break;
				default:
					return
				}
			...
			if (f.apply(this, arguments)) {
				var l, h, p, d, v, _, y, g, m, x, b, w, M, T = this
					...
					, N = "selection" === (t.event.metaKey ? k = "overlay" : k) ? ex : t.event.altKey ? ox : ix
					, S = n === ax ? null : hx[k]
					, A = n === ux ? null : px[k]
					, E = Ll(T)
					, C = E.extent
				...
				"overlay" === k ? E.selection = z = [[l = n === ax ? P : D[0], p = n === ux ? q : D[1]], [v = n === ax ? L : l, y = n === ux ? R : p]] : (l = z[0][0], p = z[0][1], v = z[1][0], y = z[1][1]), h = l, d = p, _ = v, g = y;
				var I = Ra(T).attr("pointer-events", "none")
					, Y = I.selectAll(".overlay").attr("cursor", sx[k]);
		...
		return e.move = function (t, e) {
			...
			return arguments.length ? (s = "function" == typeof t ? t : Sl([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), e) : s
		}, e.filter = function (t) {
			return arguments.length ? (f = "function" == typeof t ? t : Sl(!!t), e) : f
	...
	function Bl() {
		function t(t) {
			...
			for (e && d.sort(function (t, n) {
				...
				}), o = mx(0, gx - n * h) / o, c = o ? n : gx / h, u = 0, s = -1; ++s < h;) {
				for (a = u, f = -1; ++f < h;) {
					var m = d[s]
						, x = v[m][f]
						, b = t[m][x]
		...
		return t.padAngle = function (e) {
			return arguments.length ? (n = mx(0, e), t) : n
	...
	function Zl() {
		function t() {
			var t, a = xx.call(arguments)
				...
				, _ = i.apply(this, a) - yx
				, y = o.apply(this, a) - yx;
			if (u || (u = t = Tt()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === y || (u.quadraticCurveTo(0, 0, v * dx(_), v * vx(_)), u.arc(0, 0, v, _, y)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null, t + "" || null
		}
		var n = Hl
			, e = Xl
			, r = Vl
	...
	function sh(t, n) {
		Tb.point = fh, Mx = t, Tx = n, t *= sb, n *= sb, kx = t, Nx = pb(n = n / 2 + ub), Sx = gb(n)
	}
	...
	function fh(t, n) {
		...
		var e = t - kx
			...
			, c = Nx * o + a * pb(i)
			, s = a * r * gb(i);
		bx.add(hb(s, c)), kx = t, Nx = o, Sx = u
	}

	function lh(t) {
		return wx ? wx.reset() : (wx = Gl(), bx = Gl()), uh(t, Tb), 2 * wx
	}
	...
	function mh(t, n) {
		Dx.push(Ox = [Ax = t, Cx = t]), n < Ex && (Ex = n), n > zx && (zx = n)
	}
	...
	function xh(t, n) {
		...
		if (Rx) {
			...
			var u, a = t - Px
				...
				, s = o[0] * cb * c
				, f = fb(a) > 180;
			f ^ (c * Px < s && s < c * t) ? (u = o[1] * cb, u > zx && (zx = u)) : (s = (s + 360) % 360 - 180, f ^ (c * Px < s && s < c * t) ? (u = -o[1] * cb, u < Ex && (Ex = u)) : (n < Ex && (Ex = n), n > zx && (zx = n))), f ? t < Px ? Nh(Ax, t) > Nh(Ax, Cx) && (Cx = t) : Nh(t, Cx) > Nh(Ax, Cx) && (Ax = t) : Cx >= Ax ? (t < Ax && (Ax = t), t > Cx && (Cx = t)) : t > Px ? Nh(Ax, t) > Nh(Ax, Cx) && (Cx = t) : Nh(t, Cx) > Nh(Ax, Cx) && (Ax = t)
		}
		else mh(t, n);
		Rx = e, Px = t
	}
	...
	function wh() {
		Ox[0] = Ax, Ox[1] = Cx, kb.point = mh, Rx = null
	}

	function Mh(t, n) {
		if (Rx) {
			var e = t - Px;
			Ux.add(fb(e) > 180 ? e + (e > 0 ? 360 : -360) : e)
		}
		else qx = t, Lx = n;
		Tb.point(t, n), xh(t, n)
	}
	...
	function kh() {
		Mh(qx, Lx), Tb.lineEnd(), fb(Ux) > eb && (Ax = -(Cx = 180)), Ox[0] = Ax, Ox[1] = Cx, Rx = null
	}
	...
	function Eh(t) {
		var n, e, r, i, o, u, a;
		if (Ux ? Ux.reset() : Ux = Gl(), zx = Cx = -(Ax = Ex = 1 / 0), Dx = [], uh(t, kb), e = Dx.length) {
			for (Dx.sort(Sh), n = 1, r = Dx[0], o = [r]; n < e; ++n) i = Dx[n], Ah(r, i[0]) || Ah(r, i[1]) ? (Nh(r[0], i[1]) > Nh(r[0], r[1]) && (r[1] = i[1]), Nh(i[0], r[1]) > Nh(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
			for (u = -(1 / 0), e = o.length - 1, n = 0, r = o[e]; n <= e; r = i, ++n) i = o[n], (a = Nh(r[1], i[0])) > u && (u = a, Ax = i[0], Cx = r[1])
		}
		return Dx = Ox = null, Ax === 1 / 0 || Ex === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[Ax, Ex], [Cx, zx]]
	}
	...
	function qh(t, n) {
		t *= sb, n *= sb;
		var e = pb(n);
		Qx = e * pb(t), Kx = e * gb(t), tb = gb(n), Nb.point = Lh, zh(Qx, Kx, tb)
	}
	...
	function Dh() {
		Fh(Gx, Jx), Nb.point = Ch
	}

	function Oh(t, n) {
		Gx = t, Jx = n, t *= sb, n *= sb, Nb.point = Fh;
		var e = pb(n);
	...
	function Ih(t) {
		Fx = Ix = Yx = Bx = jx = Hx = Xx = Vx = Wx = $x = Zx = 0, uh(t, Nb);
		var n = Wx
			, e = $x
			, r = Zx
			, i = n * n + e * e + r * r;
		...
		return function (u) {
			...
			function l() {
				var t = s()
					, n = N && t
					, e = (v = w(v)).length;
				(n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && ep(v, a, t, o, u), u.polygonEnd()), S = u, v = _ = y = null
			}
			...
			function d(o, u) {
				...
				if (_ && y.push([o, u]), k) g = o, m = u, x = a, k = !1, a && (S.lineStart(), S.point(o, u));
					...
					var c = [b = Math.max(Ib, Math.min(Fb, b)), M = Math.max(Ib, Math.min(Fb, M))]
						, s = [o = Math.max(Ib, Math.min(Fb, o)), u = Math.max(Ib, Math.min(Fb, u))];
					Kh(c, s, t, n, e, r) ? (T || (S.lineStart(), S.point(c[0], c[1])), S.point(s[0], s[1]), a || S.lineEnd(), N = !1) : a && (S.lineStart(), S.point(o, u), N = !1)
				}
				b = o, M = u, T = a
			}
	...
	function up() {
		Yb.point = cp, Yb.lineEnd = ap
	}

	function ap() {
		Yb.point = Yb.lineEnd = eh
	}

	function cp(t, n) {
		t *= sb, n *= sb, Ab = t, Eb = gb(n), Cb = pb(n), Yb.point = sp
	}
	...
	function sp(t, n) {
		...
		var e = gb(n)
			...
			, c = Cb * e - Eb * r * o
			, s = Eb * e + Cb * r * o;
		Sb.add(hb(xb(a * a + c * c), s)), Ab = t, Eb = e, Cb = r
	}

	function fp(t) {
		return Sb ? Sb.reset() : Sb = Gl(), uh(t, Yb), +Sb
	}

	function lp(t, n) {
		return Bb[0] = t, Bb[1] = n, fp(jb)
	}
	...
	function dp() {
		...
		}, t.extentMajor([[-180, -90 + eb], [180, 90 - eb]]).extentMinor([[-180, -80 - eb], [180, 80 + eb]])
	}
	...
	function gp(t, n) {
		Vb.point = mp, zb = qb = t, Pb = Lb = n
	}

	function mp(t, n) {
		Xb.add(Lb * t - qb * n), qb = t, Lb = n
	}
	...
	function bp(t, n) {
		t < Wb && (Wb = t), t > Zb && (Zb = t), n < $b && ($b = n), n > Gb && (Gb = n)
	}
	...
	function kp(t, n) {
		var e = t - Db
			, r = n - Ob
			, i = xb(e * e + r * r);
		nw += i * (Db + t) / 2, ew += i * (Ob + n) / 2, rw += i, wp(Db = t, Ob = n)
	}
	...
	function Ep(t, n) {
		aw.point = Cp, wp(Rb = Db = t, Ub = Ob = n)
	}
	...
	function Cp(t, n) {
		var e = t - Db
			, r = n - Ob
			, i = xb(e * e + r * r);
		nw += i * (Db + t) / 2, ew += i * (Ob + n) / 2, rw += i, i = Ob * t - Db * n, iw += i * (Db + t), ow += i * (Ob + n), uw += 3 * i, wp(Db = t, Ob = n)
	}
	...
	function Lp() {
		...
		return t.area = function (t) {
			return uh(t, e(Vb)), Vb.result()
		}, t.bounds = function (t) {
			return uh(t, e(Jb)), Jb.result()
		}, t.centroid = function (t) {
			return uh(t, e(aw)), aw.result()
	...
	function Rp(t, n) {
		for (var e = n[0], r = n[1], i = [gb(e), -pb(e), 0], o = 0, u = 0, a = 0, c = t.length; a < c; ++a)
			if (f = (s = t[a]).length)
				for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + ub, d = gb(p), v = pb(p), _ = 0; _ < f; ++_, h = g, d = x, v = b, l = y) {
					var y = s[_]
						...
						, k = T > ib
						, N = d * x;
					if (cw.add(hb(N * M * gb(T), v * b + N * pb(T))), o += k ? w + M * ab : w, k ^ h >= e ^ g >= e) {
						var S = vh(ph(l), ph(y));
						gh(S);
						var A = vh(i, S);
						gh(A);
		...
		function o(t, n, e) {
			...
			if (!(m < 0)) {
				...
				var S = T - M
					, A = fb(S - ib) < eb
					, E = A || S < eb;
				if (!A && N < k && (w = k, k = N, N = w), E ? A ? k + N > 0 ^ b[1] < (fb(b[0] - M) < eb ? k : N) : k <= b[1] && b[1] <= N : S > ib ^ (M <= b[0] && b[0] <= T)) {
					var C = yh(_, (-y + x) / g);
		...
		function e(r, i, o, u, a, c, s, f, l, h, p, d, v, _) {
			...
			if (m > 4 * n && v--) {
				var x = u + h
					...
					, C = A - i
					, z = g * E - y * C;
				(z * z / m > n || fb((y * E + g * C) / m - .5) > .3 || u * h + a * p + c * d < lw) && (e(r, i, o, u, a, c, S, A, k, x /= M, b /= M, w, v, _), _.point(S, A), e(S, A, k, x, b, w, s, f, l, h, p, d, v, _))
			}
		}
		return function (n) {
			function r(e, r) {
			...
			function o(r, i) {
				var o = ph([r, i])
					, u = t(r, i);
				e(y, g, _, m, x, b, y = u[0], g = u[1], _ = r, m = o[0], x = o[1], b = o[2], fw, n), n.point(y, g)
			}
			...
			function s() {
				e(y, g, _, m, x, b, l, h, f, p, d, v, fw, n), w.lineEnd = u, u()
			}
	...
	function Gp(t) {
		...
		return n.stream = function (t) {
				return d && v === t ? d : d = hw(k(s, E(S(v = t))))
			}, n.clipAngle = function (t) {
				return arguments.length ? (k = +t ? Bp(T = t * sb, 6 * sb) : (T = null, sw), o()) : T * cb
			}, n.clipExtent = function (t) {
				return arguments.length ? (S = null == t ? (N = l = h = p = null, _p) : ip(N = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == N ? null : [[N, l], [h, p]]
			}, n.scale = function (t) {
				...
				return arguments.length ? (E = Vp(r, A = t * t), o()) : xb(A)
			}
			, function () {
	...
	function Kp() {
		return Jp(Qp).scale(155.424).center([0, 33.6442])
	}

	function td() {
		return Kp().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-.6, 38.7])
	}
	...
	function ed() {
		...
		var n, e, r, i, o, u, a = td()
			, c = Kp().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65])
			, s = Kp().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18])
			, f = {
				point: function (t, n) {
					u = [t, n]
				}
		...
		return t.invert = function (t) {
			...
			return n && e === t ? n : n = nd([a.stream(e = t), c.stream(t), s.stream(t)])
		}, t.precision = function (n) {
			...
			var e = a.scale()
				, u = +n[0]
				, l = +n[1];
			return r = a.translate(n).clipExtent([[u - .455 * e, l - .238 * e], [u + .455 * e, l + .238 * e]]).stream(f), i = c.translate([u - .307 * e, l + .201 * e]).clipExtent([[u - .425 * e + eb, l + .12 * e + eb], [u - .214 * e - eb, l + .234 * e - eb]]).stream(f), o = s.translate([u - .205 * e, l + .212 * e]).clipExtent([[u - .214 * e + eb, l + .166 * e + eb], [u - .115 * e - eb, l + .234 * e - eb]]).stream(f), t
		}, t.scale(1070)
	}
	...
	function od() {
		return Zp(pw).scale(124.75).clipAngle(179.999)
	}

	function ud() {
		return Zp(dw).scale(79.4188).clipAngle(179.999)
	}
	...
	function ld(t, n) {
		...
		var r = pb(t)
			, i = t === n ? gb(t) : _b(r / pb(n)) / _b(fd(n) / fd(t))
			, o = r * yb(fd(t), i) / i;
	...
	function hd() {
		return Jp(ld).scale(109.5).parallels([30, 30])
	}
	...
	function vd(t, n) {
		...
		var r = pb(t)
			...
			, o = r / i + t;
		return fb(i) < eb ? pd : (e.invert = function (t, n) {
			var e = o - n;
	...
	function _d() {
		return Jp(vd).scale(131.154).center([0, 13.9389])
	}
	...
	function gd() {
		return Zp(yd).scale(144.049).clipAngle(60)
	}
	...
	function xd() {
		return Zp(md).scale(249.5).clipAngle(90 + eb)
	}
	...
	function wd() {
		return Zp(bd).scale(250).clipAngle(142)
	}
	...
	P.prototype = q.prototype = {
		...
		, clear: function () {
			for (var t in this) t[0] === Rd && delete this[t]
		}
		, keys: function () {
			var t = [];
			for (var n in this) n[0] === Rd && t.push(n.slice(1));
			return t
		}
		, values: function () {
			var t = [];
			for (var n in this) n[0] === Rd && t.push(this[n]);
			return t
		}
		, entries: function () {
			var t = [];
			for (var n in this) n[0] === Rd && t.push({
				key: n.slice(1)
				, value: this[n]
			});
			return t
		...
		, each: function (t) {
			for (var n in this) n[0] === Rd && t(this[n], n.slice(1), this)
		}
	};
	var Ud = q.prototype;
	...
	var Dd = 3
		...
		, uv = function t(n, e) {
			...
			var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= rv);
	...
	Mt.prototype = Tt.prototype = {
			...
			if (null === this._x1) this._.push("M", this._x1 = t, ",", this._y1 = n);
				...
				if (Math.abs(f * a - c * s) > lv && i) {
					var h = e - o
						...
						, _ = Math.sqrt(d)
						, y = Math.sqrt(l)
						, g = i * Math.tan((sv - Math.acos((d + l - v) / (2 * _ * y))) / 2)
						, m = g / y
						, x = g / _;
					Math.abs(m - 1) > lv && this._.push("L", t + m * s, ",", n + m * f), this._.push("A", i, ",", i, ",0,0,", +(f * h > s * p), ",", this._x1 = t + x * a, ",", this._y1 = n + x * c)
				}
		...
		, arc: function (t, n, e, r, i, o) {
			...
			null === this._x1 ? this._.push("M", c, ",", s) : (Math.abs(this._x1 - c) > lv || Math.abs(this._y1 - s) > lv) && this._.push("L", c, ",", s), e && (l > hv ? this._.push("A", e, ",", e, ",0,1,", f, ",", t - u, ",", n - a, "A", e, ",", e, ",0,1,", f, ",", this._x1 = c, ",", this._y1 = s) : (l < 0 && (l = l % fv + fv), this._.push("A", e, ",", e, ",0,", +(l >= sv), ",", f, ",", this._x1 = t + e * Math.cos(i), ",", this._y1 = n + e * Math.sin(i))))
		}
	...
	var pv = jt.prototype = Ht.prototype;
	pv.copy = function () {
		...
		return e
	}, pv.add = kt, pv.addAll = St, pv.cover = At, pv.data = Et, pv.extent = Ct, pv.find = Pt, pv.remove = qt, pv.removeAll = Lt, pv.root = Rt, pv.size = Ut, pv.visit = Dt, pv.visitAfter = Ot, pv.x = It, pv.y = Bt;
	var dv = [].slice
		, vv = {};
	...
	var bv = {
		...
		, kv = {
			draw: function (t, n) {
				var e = Math.sqrt(n / Tv)
					, r = e * Mv;
				t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
			}
		}
		, Nv = .8908130915292852
		, Sv = Math.sin(yv / 10) / Math.sin(7 * yv / 10)
		, Av = Math.sin(mv / 10) * Sv
		, Ev = -Math.cos(mv / 10) * Sv
		, Cv = {
			draw: function (t, n) {
		...
		, qv = {
			draw: function (t, n) {
				var e = -Math.sqrt(n / (3 * Pv));
				t.moveTo(0, 2 * e), t.lineTo(-Pv * e, -e), t.lineTo(Pv * e, -e), t.closePath()
			}
		}
		, Lv = -.5
		, Rv = Math.sqrt(3) / 2
		...
		, Ov = {
			draw: function (t, n) {
				var e = Math.sqrt(n / Dv)
					...
					, a = -o
					, c = u;
				t.moveTo(r, i), t.lineTo(o, u), t.lineTo(a, c), t.lineTo(Lv * r - Rv * i, Rv * r + Lv * i), t.lineTo(Lv * o - Rv * u, Rv * o + Lv * u), t.lineTo(Lv * a - Rv * c, Rv * a + Lv * c), t.lineTo(Lv * r + Rv * i, Lv * i - Rv * r), t.lineTo(Lv * o + Rv * u, Lv * u - Rv * o), t.lineTo(Lv * a + Rv * c, Lv * c - Rv * a), t.closePath()
			}
		}
		, Fv = [bv, wv, kv, zv, Cv, qv, Ov];
	Sn.prototype = {
		areaStart: function () {
			this._line = 0
		}
	...
	var Iv = function t(n) {
		function e(t) {
			return 1 === n ? new Sn(t) : new qn(t, n)
		}
	...
	var Wv = Array.prototype.slice
		...
		, Gv = /^#([0-9a-f]{3})$/
		, Jv = /^#([0-9a-f]{6})$/
		, Qv = /^rgb\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*\)$/
		, Kv = /^rgb\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/
		, t_ = /^rgba\(\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+)\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/
		, n_ = /^rgba\(\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/
		, e_ = /^hsl\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*\)$/
		, r_ = /^hsla\(\s*([-+]?\d+(?:\.\d+)?)\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)%\s*,\s*([-+]?\d+(?:\.\d+)?)\s*\)$/
		, i_ = {
			aliceblue: 15792383
	...
	ge(xe, be, {
		...
		brighter: function (t) {
			return t = null == t ? Zv : Math.pow(Zv, t), new Ne(this.r * t, this.g * t, this.b * t, this.opacity)
		}
		, darker: function (t) {
			return t = null == t ? $v : Math.pow($v, t), new Ne(this.r * t, this.g * t, this.b * t, this.opacity)
		}
		, rgb: function () {
			return this
		}
		...
		brighter: function (t) {
			return t = null == t ? Zv : Math.pow(Zv, t), new Ce(this.h, this.s, this.l * t, this.opacity)
		}
		, darker: function (t) {
			return t = null == t ? $v : Math.pow($v, t), new Ce(this.h, this.s, this.l * t, this.opacity)
		}
		, rgb: function () {
			var t = this.h % 360 + 360 * (this.h < 0)
				...
				, r = e + (e < .5 ? e : 1 - e) * n
				, i = 2 * e - r;
			return new Ne(ze(t >= 240 ? t - 240 : t + 120, i, r), ze(t, i, r), ze(t < 120 ? t + 240 : t - 120, i, r), this.opacity)
		}
		, displayable: function () {
	...
	ge(Le, qe, me(xe, {
		brighter: function (t) {
			return new Le(this.l + a_ * (null == t ? 1 : t), this.a, this.b, this.opacity)
		}
		, darker: function (t) {
			return new Le(this.l - a_ * (null == t ? 1 : t), this.a, this.b, this.opacity)
		}
		, rgb: function () {
			...
			return t = s_ * Ue(t), n = c_ * Ue(n), e = f_ * Ue(e), new Ne(De(3.2404542 * n - 1.5371385 * t - .4985314 * e), De(-.969266 * n + 1.8760108 * t + .041556 * e), De(.0556434 * n - .2040259 * t + 1.0572252 * e), this.opacity)
		}
	})), ge(Ye, Ie, me(xe, {
		brighter: function (t) {
			return new Ye(this.h, this.c, this.l + a_ * (null == t ? 1 : t), this.opacity)
		}
		, darker: function (t) {
			return new Ye(this.h, this.c, this.l - a_ * (null == t ? 1 : t), this.opacity)
		}
	...
	ge(He, je, me(xe, {
		brighter: function (t) {
			return t = null == t ? Zv : Math.pow(Zv, t), new He(this.h, this.s, this.l * t, this.opacity)
		}
		, darker: function (t) {
			return t = null == t ? $v : Math.pow($v, t), new He(this.h, this.s, this.l * t, this.opacity)
		}
		, rgb: function () {
			var t = isNaN(this.h) ? 0 : (this.h + 120) * o_
				, n = +this.l
				, e = isNaN(this.s) ? 0 : this.s * n * (1 - n)
				, r = Math.cos(t)
				, i = Math.sin(t);
			return new Ne(255 * (n + e * (v_ * r + __ * i)), 255 * (n + e * (y_ * r + g_ * i)), 255 * (n + e * (m_ * r)), this.opacity)
		}
	}));
	var M_, T_, k_, N_, S_ = function t(n) {
			function e(t, n) {
		...
		, on: function (t, n) {
			var e, r = this._
				...
				if (!(arguments.length < 2)) {
					...
					for (; ++o < u;)
						if (e = (t = i[o]).type) r[e] = Sr(r[e], t.name, n);
						else if (null == n)
						for (e in r) r[e] = Sr(r[e], t.name, null);
					return this
				}
				for (; ++o < u;)
					if ((e = (t = i[o]).type) && (e = Nr(r[e], t.name))) return e
			}
		}
		, copy: function () {
			var t = {}
	...
	var W_, $_, Z_ = zr(",")
		...
		, ry = ty.format
		, iy = ty.formatRows
		, oy = Rr("text/html", function (t) {
			return document.createRange().createContextualFragment(t.responseText)
		})
		, uy = Rr("application/json", function (t) {
			return JSON.parse(t.responseText)
		})
		, ay = Rr("text/plain", function (t) {
			return t.responseText
		})
		, cy = Rr("application/xml", function (t) {
			var n = t.responseXML;
			if (!n) throw new Error("parse error");
			return n
		})
		, sy = Ur("text/csv", G_)
		, fy = Ur("text/tab-separated-values", ny)
		, ly = 0
		, hy = 0
		, py = 0
		, dy = 1e3
		...
		, _y = 0
		, yy = 0
		, gy = "object" == typeof performance && performance.now ? performance : Date
		, my = "function" == typeof requestAnimationFrame ? gy === Date ? function (t) {
	...
	Ir.prototype = Yr.prototype = {
		...
		, restart: function (t, n, e) {
			...
			e = (null == e ? Or() : +e) + (null == n ? 0 : +n), this._next || $_ === this || ($_ ? $_._next = this : W_ = this, $_ = this), this._call = t, this._time = e, Vr()
		}
		, stop: function () {
	...
	var My = wy.range
		...
		, Py = zy.range
		, qy = Zr(function (t) {
			var n = t.getTimezoneOffset() * ky % Ny;
			n < 0 && (n += Ny), t.setTime(Math.floor((+t - n) / Ny) * Ny + n)
		}, function (t, n) {
			t.setTime(+t + n * Ny)
		}, function (t, n) {
			return (n - t) / Ny
		...
		, Ry = Zr(function (t) {
			...
			return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * ky) / Sy
		}, function (t) {
			return t.getDate() - 1
		})
		, Uy = Ry.range
	...
	var Ag, Eg = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];
	t.format, t.formatPrefix, ci({
		decimal: "."
		, thousands: ","
		, grouping: [3]
		, currency: ["$", ""]
	...
	var Cg, zg = {
		...
		, qg = /^%/
		, Lg = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
	t.timeFormat, t.timeParse, t.utcFormat, t.utcParse, so({
		dateTime: "%x, %X"
		, date: "%-m/%-d/%Y"
		, time: "%-I:%M:%S %p"
		, periods: ["AM", "PM"]
	...
	var Rg = "%Y-%m-%dT%H:%M:%S.%LZ"
		, Ug = Date.prototype.toISOString ? fo : t.utcFormat(Rg)
		, Dg = +new Date("2000-01-01T00:00:00.000Z") ? lo : t.utcParse(Rg)
		, Og = Array.prototype
		, Fg = Og.map
		, Ig = Og.slice
		, Yg = {
		...
		, $g = 30 * Vg
		, Zg = 365 * Vg
		, Gg = Zo("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf")
		...
		, Qg = Zo("3182bd6baed69ecae1c6dbefe6550dfd8d3cfdae6bfdd0a231a35474c476a1d99bc7e9c0756bb19e9ac8bcbddcdadaeb636363969696bdbdbdd9d9d9")
		...
		, tm = X_(je(300, .5, 0), je(-240, .5, 1))
		, nm = X_(je(-100, .75, .35), je(80, 1.5, .8))
		, em = X_(je(260, .75, .35), je(80, 1.5, .8))
		, rm = je()
		, im = Jo(Zo(""))
	...
	if ("undefined" != typeof document) {
		...
		if (!hm.matches) {
			var pm = hm.webkitMatchesSelector || hm.msMatchesSelector || hm.mozMatchesSelector || hm.oMatchesSelector;
			lm = function (t) {
				return function () {
					return pm.call(this, t)
				}
			}
		}
	}
	...
	if (t.event = null, "undefined" != typeof document) {
		var _m = document.documentElement;
		"onmouseenter" in _m || (vm = {
	...
	var bx, wx, Mx, Tx, kx, Nx, Sx, Ax, Ex, Cx, zx, Px, qx, Lx, Rx, Ux, Dx, Ox, Fx, Ix, Yx, Bx, jx, Hx, Xx, Vx, Wx, $x, Zx, Gx, Jx, Qx, Kx, tb, nb = new Jl
		, eb = 1e-6
		, rb = 1e-12
		, ib = Math.PI
		, ob = ib / 2
		...
		, Tb = {
			...
			, lineEnd: eh
			, polygonStart: function () {
				bx.reset(), Tb.lineStart = ah, Tb.lineEnd = ch
			}
			, polygonEnd: function () {
				var t = +bx;
				wx.add(t < 0 ? ab + t : t), this.lineStart = this.lineEnd = this.point = eh
			}
			, sphere: function () {
				wx.add(ab)
			}
		...
		, kb = {
			...
			, lineEnd: wh
			, polygonStart: function () {
				kb.point = Mh, kb.lineStart = Th, kb.lineEnd = kh, Ux.reset(), Tb.polygonStart()
			}
			, polygonEnd: function () {
				Tb.polygonEnd(), kb.point = mh, kb.lineStart = bh, kb.lineEnd = wh, bx < 0 ? (Ax = -(Cx = 180), Ex = -(zx = 90)) : Ux > eb ? zx = 90 : Ux < -eb && (Ex = -90), Ox[0] = Ax, Ox[1] = Cx
			}
		}
		, Nb = {
			sphere: eh
			...
			, lineEnd: Rh
			, polygonStart: function () {
				Nb.lineStart = Uh, Nb.lineEnd = Dh
			}
			, polygonEnd: function () {
				Nb.lineStart = Ph, Nb.lineEnd = Rh
			}
		};
	jh.invert = jh;
	var Sb, Ab, Eb, Cb, zb, Pb, qb, Lb, Rb, Ub, Db, Ob, Fb = 1e9
		, Ib = -Fb
		, Yb = {
			sphere: eh
			, point: eh
		...
		, Vb = {
			...
			, lineEnd: eh
			, polygonStart: function () {
				Vb.lineStart = yp, Vb.lineEnd = xp
			}
			, polygonEnd: function () {
				Vb.lineStart = Vb.lineEnd = Vb.point = eh, Hb.add(fb(Xb)), Xb.reset()
			}
			, result: function () {
				var t = Hb / 2;
				return Hb.reset(), t
		...
		, aw = {
			...
			, lineEnd: Np
			, polygonStart: function () {
				aw.lineStart = Sp, aw.lineEnd = Ap
			}
			, polygonEnd: function () {
				aw.point = wp, aw.lineStart = Mp, aw.lineEnd = Np
			}
			, result: function () {
				var t = uw ? [iw / uw, ow / uw] : rw ? [nw / rw, ew / rw] : tw ? [Qb / tw, Kb / tw] : [NaN, NaN];
				return Qb = Kb = tw = nw = ew = rw = iw = ow = uw = 0, t
			}
		}
		, cw = Gl()
		, sw = Up(function () {
