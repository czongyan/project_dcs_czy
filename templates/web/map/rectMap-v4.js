...
(function (global) {
    ...
    function line_fineGrit(data) {
        ...
        for (var i in settings.parameterName) {
            ...
            //            .range([settings.strokeWidth * settings.g_dis[0], 0]).domain(d3.extent(data, function (d) {
            //                return d.MSP;
            //            }));
            //
        ...
        //        rect_g.append("path")
        //            .attr("class", "line")
        //            .attr("d", line1).style("stroke", "#FC9E27").style("stroke-width", "1px");
        //
        //        rect_g.append("path")
        //            .attr("class", "line")
        //            .attr("d", line2).style("stroke", "#66bd63").style("stroke-width", "1px");
