...
(function (global) {
    ...
    function display_seg(data) {
        ...
        for (var i in data) {
            var d = data[i];
            var rect = g.append("rect").attr("class", "map_rect").attr("x", d.x)
                ...
                }).style("stroke-width", 0.3).style("stroke", "#252525").style("opacity", function () {
                    /*根据磨煤机更改透明度          if (settings.nomLimit) {
                                  if ((d.MW >= settings.mwDomain[0]) && (d.MW < settings.mwDomain[1])) {
                                      if (settings.nom == 5 && d.NOM >= 5) {
                                          return settings.alpha;
                    ...
                    if (settings.nomLimit) {
                        if ((d.MW >= settings.mwDomain[0]) && (d.MW < settings.mwDomain[1])) {
                            ...
                            if (d.resolution > 0) {
                                ...
                                //                                    console.log(settings.alpha*2/3,settings.alpha/2)
                                return (settings.alpha * 2 / 3);
                            }
                        }
                    } else return settings.alpha;
